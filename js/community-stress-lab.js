...
(function () {
  ...
  var CSL_STRINGS = {
    ...
    'no_species_match': 'No species matched that search — try a different name or spelling.',
    'select_species_for_findings': 'Add a species or two to see what this mix might ask of you.',
    'no_findings': 'Nothing major stood out here — a good sign, though your own eyes on the tank still matter more than any model.',
    'could_not_load': 'Couldn\'t load the species data — check your connection and try refreshing.',
    ...
    'lane_level_low': 'low',
    'checklist_priority': 'Worth revisiting: read up on “{title}” before adding more livestock.',
    'r_thermal_gap_title': 'No shared temperature window',
    'r_thermal_gap_body': 'These species don\'t share a comfortable temperature range on paper — worth digging into sources a bit more before committing to this mix.',
    'r_thermal_narrow_title': 'Very narrow temperature overlap',
    'r_thermal_narrow_body': 'There\'s only about {width} °C of shared comfort here — a small heater drift or seasonal swing could push one of them outside it, so it\'s worth keeping an eye on.',
    'r_ph_gap_title': 'pH targets do not overlap',
    'r_ph_gap_body': 'Their general pH ranges don\'t overlap — your source water and buffering will matter more than usual here, so it\'s worth testing before you commit.',
    'r_ph_narrow_title': 'Tight pH overlap',
    'r_ph_narrow_body': 'The shared pH window is tight — testing your tap and tank chemistry first will save some guesswork.',
    'r_coldwarm_mix_title': 'Coldwater mixed with tropical',
    'r_coldwarm_mix_body': 'Coldwater species (like goldfish) and tropical species rarely settle into one stable long-term plan together — this pairing tends to ask a lot of whichever species has to compromise.',
    'r_bioload_high_title': 'Bioload proxy is high for this volume',
    'r_bioload_high_body': 'This mix asks a lot of a {volumeL} L tank — worth matching it with stronger filtration, more plants, or more frequent water changes before you commit.',
    'r_bioload_proxy_title': 'Bioload proxy is elevated',
    'r_bioload_proxy_body': 'You\'re building up a meaningful amount of livestock for this volume — leaving some margin for growth and the occasional messy week will help.',
    'r_small_tank_title': 'Small tank, many lifestyles',
    'r_small_tank_body': 'Under {smallTankL} L, territory and water quality can swing faster with several species or aggressive cichlids in the mix — smaller systems just have less room to absorb friction.',
    'r_mbuna_community_title': 'Mbuna with non-mbuna fish',
    'r_mbuna_community_body': 'Rock-dwelling mbuna run on a different social model than typical community fish — mixing the two usually means ongoing aggression or stress for someone.',
    'r_predation_title': 'Mouth / body mismatch',
    'r_predation_body': '{predatorName} may see very small tankmates like {preyName} as food rather than company — it varies by individual, but it\'s worth planning for.',
    'r_shrimp_risk_high_title': 'Shrimp with high-risk fish',
    'r_shrimp_risk_high_body': 'Active predators, nippers, or aggressive cichlids often make life hard for dwarf shrimp — in most typical setups, the shrimp are the ones who pay for it.',
    'r_shrimp_risk_mod_title': 'Shrimp with moderate-risk fish',
    'r_shrimp_risk_mod_body': 'Some fish leave shrimp alone, others don\'t — it depends on the individual. Plenty of hiding places help, and it\'s worth watching numbers over weeks rather than expecting an answer on day one.',
    'r_fin_nipper_title': 'Fin-nipping exposure',
    'r_fin_nipper_body': 'You\'ve paired a nipping species with long fins or labyrinth fish — keeping an eye on fin condition daily for the first while is a good habit here.',
    'r_tiger_school_title': 'Tiger barbs in a small group',
    'r_tiger_school_body': 'Tiger barbs tend to get nippier in groups smaller than ~{tigerMinSchool} — a bigger school often redirects that energy within the group instead of toward tankmates.',
    'r_schooling_title': '{name} — low group size',
    'r_schooling_body': 'This species does best in larger groups (about {schoolingMin}+) — in smaller numbers, they tend to hide or stay skittish rather than settle in.',
    'r_betta_male_multi_title': 'Multiple male bettas — fighting near-certain',
    'r_betta_male_multi_body': 'Male bettas are strongly territorial and will fight if housed together — fin damage, stress, and worse are the typical outcome outside of very large, heavily-divided setups. This isn\'t one to test and see.',
    'r_betta_male_flow_title': 'Male betta with very active swimmers',
    'r_betta_male_flow_body': 'Fast mid-water fish can stress a male betta by repeatedly crossing his territory — flaring, torn fins, or a drop in appetite are worth watching for.',
    'r_betta_male_gourami_title': 'Male betta with other labyrinth fish',
    'r_betta_male_gourami_body': 'Multiple labyrinth species tend to dispute the surface — floating plants and breaking line of sight help, but some aggression is common even with those in place.',
    'r_gbr_heat_title': 'Warm-specialist in a cool-overlap window',
    'r_gbr_heat_body': 'Warm-loving fish need consistently warm water — if the shared range for this group runs low, it\'s worth giving the heater and room temperature some extra headroom.',
    'r_discus_complex_title': 'Discus with a mismatched lifestyle mix',
    'r_discus_complex_body': 'Discus care (temperature, flow, temperament) rarely lines up with coldwater, high-chase, or mbuna setups — this combination tends to create extra friction for everyone.',
    'r_snail_loach_hunter_title': 'Snails with a dedicated snail hunter',
    'r_snail_loach_hunter_body': '{name} actively hunts snails — expect the shell population to decline noticeably over time, which may or may not be what you\'re after.',
    'r_snail_loach_maybe_title': 'Snails with a potential snail eater',
    'r_snail_loach_maybe_body': 'There are some reports of {name} disturbing snails — it\'s worth keeping an eye on numbers over several weeks rather than assuming either way.',
    'r_snail_loach_cichlid_title': 'Mystery snail with aggressive cichlid',
    'r_snail_loach_cichlid_body': 'Aggressive cichlids may harass or injure mystery snails — their antennae and soft parts are especially vulnerable.',
    'r_invert_assassin_title': 'Assassin snail with small inverts',
    'r_invert_assassin_body': 'Assassin snails prey on pest snails, and may also take dwarf shrimp — especially juveniles — so it\'s worth watching closely in a mixed invert setup.',
    'r_zone_benthic_crowd_title': 'Multiple bottom-dwellers in a small tank',
    'r_zone_benthic_crowd_body': 'Several bottom-dwelling species ({names}) end up competing for the same substrate territory — that friction tends to increase in tanks under {smallTankL} L.',
    ...
    'no_species_match': 'Tidak ada spesies yang cocok dengan pencarian itu — coba nama atau ejaan lain.',
    'select_species_for_findings': 'Tambahkan satu atau dua spesies untuk melihat apa yang diminta kombinasi ini dari Anda.',
    'no_findings': 'Tidak ada yang menonjol di sini — pertanda baik, meski mata Anda sendiri pada akuarium tetap lebih berarti daripada model manapun.',
    'could_not_load': 'Data spesies gagal dimuat — periksa koneksi Anda lalu coba muat ulang.',
    'lane_thermal': 'Termal',
    ...
    'checklist_priority': 'Ada baiknya ditinjau ulang: baca lagi soal “{title}” sebelum menambah penghuni baru.',
    'r_thermal_gap_title': 'Tidak ada jendela suhu bersama',
    'r_thermal_gap_body': 'Di atas kertas, spesies-spesies ini tidak berbagi rentang suhu yang nyaman — ada baiknya menelusuri sumber lebih dalam sebelum memutuskan kombinasi ini.',
    'r_thermal_narrow_title': 'Irisan suhu sangat sempit',
    'r_thermal_narrow_body': 'Zona nyaman bersama di sini hanya sekitar {width} °C — pergeseran kecil pada heater atau pergantian musim bisa membuat salah satu spesies keluar dari zona itu, jadi ada baiknya terus dipantau.',
    'r_ph_gap_title': 'Target pH tidak beririsan',
    'r_ph_gap_body': 'Rentang pH umum keduanya tidak berpotongan — air sumber dan daya buffer Anda akan lebih menentukan daripada biasanya, jadi ada baiknya diuji dulu sebelum diputuskan.',
    'r_ph_narrow_title': 'Irisan pH sempit',
    'r_ph_narrow_body': 'Jendela pH gabungan tergolong sempit — menguji kimia air keran dan air akuarium lebih dulu akan menghemat banyak tebakan.',
    'r_coldwarm_mix_title': 'Ikan air dingin dicampur dengan ikan tropis',
    'r_coldwarm_mix_body': 'Spesies air dingin (seperti ikan mas koki) dan spesies tropis jarang bisa menetap dalam satu rencana jangka panjang yang stabil bersama — kombinasi ini biasanya menuntut banyak dari pihak yang harus mengalah.',
    'r_bioload_high_title': 'Perkiraan beban biologis tinggi untuk volume ini',
    'r_bioload_high_body': 'Kombinasi ini menuntut banyak dari akuarium {volumeL} L — ada baiknya diimbangi dengan filtrasi yang lebih kuat, tanaman lebih banyak, atau penggantian air lebih sering sebelum diputuskan.',
    'r_bioload_proxy_title': 'Perkiraan beban biologis meningkat',
    'r_bioload_proxy_body': 'Anda sedang membangun jumlah penghuni yang cukup berarti untuk volume ini — menyisakan ruang untuk pertumbuhan dan hari-hari yang berantakan akan sangat membantu.',
    'r_small_tank_title': 'Akuarium kecil, banyak gaya hidup',
    'r_small_tank_body': 'Di bawah {smallTankL} L, teritori dan kualitas air bisa berayun lebih cepat kalau ada beberapa spesies atau cichlid agresif dalam campuran — sistem kecil memang punya lebih sedikit ruang untuk menyerap gesekan.',
    'r_mbuna_community_title': 'Mbuna bersama ikan non-mbuna',
    'r_mbuna_community_body': 'Mbuna penghuni bebatuan mengikuti model sosial yang berbeda dari ikan komunitas pada umumnya — mencampur keduanya biasanya berarti agresi atau stres berkepanjangan bagi salah satu pihak.',
    'r_predation_title': 'Ketidaksesuaian ukuran mulut / tubuh',
    'r_predation_body': '{predatorName} mungkin melihat teman seakuarium yang sangat kecil seperti {preyName} sebagai makanan, bukan sebagai teman — ini bervariasi menurut individu, tapi ada baiknya direncanakan.',
    'r_shrimp_risk_high_title': 'Udang bersama ikan berisiko tinggi',
    'r_shrimp_risk_high_body': 'Predator aktif, penggigit sirip, atau cichlid agresif sering membuat hidup udang kerdil sulit — pada kebanyakan penataan umum, udanglah yang menanggung akibatnya.',
    'r_shrimp_risk_mod_title': 'Udang bersama ikan berisiko sedang',
    'r_shrimp_risk_mod_body': 'Sebagian ikan membiarkan udang saja, sebagian lagi tidak — tergantung individunya. Banyak tempat bersembunyi akan membantu, dan ada baiknya memantau jumlah udang selama beberapa minggu, bukan berharap jawaban di hari pertama.',
    'r_fin_nipper_title': 'Paparan gigitan sirip',
    'r_fin_nipper_body': 'Anda memasangkan spesies penggigit sirip dengan ikan bersirip panjang atau ikan labirin — memeriksa kondisi sirip setiap hari di awal adalah kebiasaan baik di sini.',
    'r_tiger_school_title': 'Tiger barb dalam kelompok kecil',
    'r_tiger_school_body': 'Tiger barb cenderung lebih suka menggigit dalam kelompok di bawah ~{tigerMinSchool} ekor — kelompok yang lebih besar sering mengalihkan energi itu ke dalam kelompoknya sendiri, bukan ke teman seakuarium lain.',
    'r_schooling_title': '{name} — ukuran kelompok terlalu kecil',
    'r_schooling_body': 'Spesies ini paling baik dalam kelompok yang lebih besar (sekitar {schoolingMin}+ ekor) — dalam jumlah kecil, mereka cenderung bersembunyi atau tetap gugup, bukannya betah.',
    'r_betta_male_multi_title': 'Beberapa betta jantan — perkelahian hampir pasti',
    'r_betta_male_multi_body': 'Betta jantan sangat teritorial dan akan berkelahi jika dipelihara bersama — sirip rusak, stres, dan yang lebih buruk adalah hasil yang biasa terjadi di luar penataan yang sangat besar dan bersekat rapat. Ini bukan kombinasi yang layak dicoba-coba.',
    'r_betta_male_flow_title': 'Betta jantan bersama perenang yang sangat aktif',
    'r_betta_male_flow_body': 'Ikan cepat penghuni air tengah bisa membuat betta jantan stres karena berulang kali melintasi teritorinya — sirip mengembang, sirip robek, atau nafsu makan menurun patut diperhatikan.',
    'r_betta_male_gourami_title': 'Betta jantan bersama ikan labirin lain',
    'r_betta_male_gourami_body': 'Beberapa spesies labirin cenderung memperebutkan permukaan — tanaman apung dan pemutus garis pandang membantu, tetapi sebagian agresi tetap umum terjadi walau keduanya sudah disediakan.',
    'r_gbr_heat_title': 'Spesialis air hangat dalam jendela irisan yang sejuk',
    'r_gbr_heat_body': 'Ikan penyuka suhu hangat butuh air hangat yang konsisten — kalau rentang bersama kelompok ini berada di sisi rendah, ada baiknya memberi ruang cadangan ekstra pada heater dan suhu ruangan.',
    'r_discus_complex_title': 'Discus dengan campuran gaya hidup yang tidak sepadan',
    'r_discus_complex_body': 'Perawatan discus (suhu, arus, temperamen) jarang sejalan dengan penataan air dingin, ikan pengejar aktif, atau mbuna — kombinasi ini cenderung menciptakan gesekan ekstra bagi semua pihak.',
    'r_snail_loach_hunter_title': 'Siput bersama pemburu siput sejati',
    'r_snail_loach_hunter_body': '{name} aktif memburu siput — populasi siput akan menurun secara nyata seiring waktu, yang mungkin sesuai atau tidak sesuai dengan yang Anda inginkan.',
    'r_snail_loach_maybe_title': 'Siput bersama pemakan siput potensial',
    'r_snail_loach_maybe_body': 'Ada beberapa laporan {name} mengganggu siput — ada baiknya memantau jumlahnya selama beberapa minggu, bukan langsung berasumsi.',
    'r_snail_loach_cichlid_title': 'Mystery snail bersama cichlid agresif',
    'r_snail_loach_cichlid_body': 'Cichlid agresif dapat mengganggu atau melukai mystery snail — antena dan bagian tubuhnya yang lunak sangat rentan.',
    'r_invert_assassin_title': 'Assassin snail bersama invertebrata kecil',
    'r_invert_assassin_body': 'Assassin snail memangsa siput hama, dan mungkin juga memakan udang kerdil — terutama yang masih muda — jadi ada baiknya dipantau ketat pada penataan invertebrata campuran.',
    'r_zone_benthic_crowd_title': 'Beberapa penghuni dasar dalam akuarium kecil',
    'r_zone_benthic_crowd_body': 'Beberapa spesies penghuni dasar ({names}) akhirnya bersaing memperebutkan teritori substrat yang sama — gesekan itu cenderung meningkat di akuarium di bawah {smallTankL} L.',
    ...
    'no_species_match': 'その検索に合う種は見つかりませんでした。別の名前やつづりで試してみてください。',
    'select_species_for_findings': '種を1〜2匹追加すると、この組み合わせが何を求めているか見えてきます。',
    'no_findings': 'このモデルでは、大きな負荷の重なりは見つかりませんでした。良い兆候ですが、どんなモデルよりも、あなた自身の目で見た水槽の様子がいちばん頼りになります。',
    'could_not_load': '種のデータを読み込めませんでした。通信状態を確認して、もう一度読み込んでみてください。',
    'lane_thermal': '水温',
    'lane_chemistry': '水質',
    'lane_space': '広さ・生体量',
    'lane_predation': '捕食',
    ...
    'lane_level_low': '低い',
    'checklist_priority': '見直しておきたいこと：生体を増やす前に、「{title}」についてもう一度確かめてみてください。',
    'r_thermal_gap_title': '共通する水温域がない',
    'r_thermal_gap_body': '資料の上では、これらの種は快適に感じる水温が重なっていません。混泳を試す前に、出典をもう少し詳しく確認してみると安心です。',
    'r_thermal_narrow_title': '水温の重なりがとても狭い',
    'r_thermal_narrow_body': '共通の快適域は約 {width} °C しかありません。ヒーターのわずかなずれや季節の変化で、どちらかが快適な範囲から外れてしまうことがあるので、様子を見ておくと安心です。',
    'r_ph_gap_title': '目標とする pH が重ならない',
    'r_ph_gap_body': '一般的な pH の範囲どうしが重なっていません。元の水と緩衝能が、いつも以上に大事になるので、混泳前に確かめておくと安心です。',
    'r_ph_narrow_title': 'pH の重なりが狭い',
    'r_ph_narrow_body': '全体で見た pH の幅は狭めです。水道水と水槽の水質を先に測っておくと、あとで迷わずに済みます。',
    'r_coldwarm_mix_title': '低水温の種と熱帯魚の混泳',
    'r_coldwarm_mix_body': '金魚のような低水温の種と熱帯魚は、長期にわたって同じ安定した環境を共有するのが難しいことが多いです。どちらかが無理をして合わせることになりがちな組み合わせです。',
    'r_bioload_high_title': 'この水量に対して生体量の目安が高い',
    'r_bioload_high_body': 'この組み合わせは {volumeL} L の水槽にとって少し負担が大きいようです。ろ過を強めにしたり、水草を増やしたり、換水を少し頻繁にしたりすると、バランスが取りやすくなります。',
    'r_bioload_proxy_title': '生体量の目安がやや高い',
    'r_bioload_proxy_body': 'この水量に対して、生体の量がそれなりに増えてきています。今後の成長や、水が汚れがちな日のために、少し余裕を残しておくと安心です。',
    'r_small_tank_title': '小さな水槽に、多様な暮らし方',
    'r_small_tank_body': '{smallTankL} L 未満の水槽では、複数の種や気の荒いシクリッドがいると、縄張りも水質も揺れやすくなります。小さな水槽ほど、摩擦を吸収する余裕が少ないのは自然なことです。',
    'r_mbuna_community_title': 'ムブナと、それ以外の魚',
    'r_mbuna_community_body': '岩場に暮らすムブナは、一般的な混泳魚とは違う社会性を持っています。混ぜると、どちらかに慢性的な攻撃やストレスがかかることが多いです。',
    'r_predation_title': '口と体の大きさの不釣り合い',
    'r_predation_body': '{predatorName} は、{preyName} のようなとても小さな同居魚を、仲間ではなく餌として見てしまうことがあります。個体差はありますが、計画に入れておくと安心です。',
    'r_shrimp_risk_high_title': 'シュリンプと、危険度の高い魚',
    'r_shrimp_risk_high_body': '活発な捕食魚、ヒレをかじる魚、気の荒いシクリッドがいると、多くのレイアウトで小型シュリンプが追い詰められたり食べられたりしてしまいます。負担を背負うのはたいていシュリンプの側です。',
    'r_shrimp_risk_mod_title': 'シュリンプと、危険度が中くらいの魚',
    'r_shrimp_risk_mod_body': 'シュリンプに見向きもしない魚もいれば、そうでない魚もいます。個体差が大きいところなので、隠れ家を多めに用意し、数の変化を数時間ではなく数週間かけてゆっくり確かめてみてください。',
    'r_fin_nipper_title': 'ヒレをかじられる恐れ',
    'r_fin_nipper_body': 'ヒレをかじる種と、長いヒレの魚やアナバス類を組み合わせています。導入後しばらくは、毎日ヒレの様子を確認する習慣をつけておくと安心です。',
    'r_tiger_school_title': 'スマトラの群れが小さい',
    'r_tiger_school_body': 'スマトラは群れが約 {tigerMinSchool} を下回ると、ヒレをかじりやすくなる傾向があります。群れを大きくすると、そのエネルギーが同居魚ではなく群れの中に向かうことが多いです。',
    'r_schooling_title': '{name} — 群れの数が少ない',
    'r_schooling_body': 'この種は、もっと大きな群れ（およそ {schoolingMin} 以上）でこそ落ち着きます。小さな群れのままだと、隠れがちになったり、おびえた様子を見せたりしやすいです。',
    'r_betta_male_multi_title': 'オスのベタが複数 — 争いはほぼ確実',
    'r_betta_male_multi_body': 'オスのベタは縄張り意識がとても強く、一緒に入れると争います。とても大きく、しっかり仕切った水槽でない限り、ヒレの損傷やストレス、それ以上の結果につながるのがふつうです。試してみる価値がある組み合わせではありません。',
    'r_betta_male_flow_title': 'オスのベタと、とても活発に泳ぐ魚',
    'r_betta_male_flow_body': '中層を速く泳ぐ魚が縄張りを何度も横切ると、オスのベタが疲弊してしまうことがあります。エラを広げる威嚇や裂けたヒレ、食欲の低下が見られないか、気にかけてあげてください。',
    'r_betta_male_gourami_title': 'オスのベタと、ほかのアナバス類',
    'r_betta_male_gourami_body': 'アナバス類が複数いると、水面をめぐって争いやすくなります。視線を遮る配置や浮き草は助けになりますが、それでも攻撃が見られることは少なくありません。',
    'r_gbr_heat_title': '高水温を好む種に、低めの重なり幅',
    'r_gbr_heat_body': '高水温を好む魚には、安定して暖かい水が必要です。このグループの共通範囲が低めに寄っている場合は、ヒーターと室温に少し余裕を持たせておくと安心です。',
    'r_discus_complex_title': 'ディスカスと、暮らし方の合わない組み合わせ',
    'r_discus_complex_body': 'ディスカスの飼い方（水温、水流、気質）は、低水温の魚や追いかけ回す魚、ムブナの水槽とかみ合うことがほとんどありません。この組み合わせは、どちらにとっても余分な摩擦を生みやすいです。',
    'r_snail_loach_hunter_title': '貝と、貝を専門に狩る魚',
    'r_snail_loach_hunter_body': '{name} は貝を積極的に狩ります。時間とともに貝の数は目に見えて減っていくので、それが望む結果かどうか考えておくとよいでしょう。',
    'r_snail_loach_maybe_title': '貝と、貝を食べる可能性のある魚',
    'r_snail_loach_maybe_body': '{name} が貝にちょっかいを出したという報告もあります。断定はできないので、数週間かけて数の変化を見てみてください。',
    'r_snail_loach_cichlid_title': 'ミステリースネールと、気の荒いシクリッド',
    'r_snail_loach_cichlid_body': '気の荒いシクリッドは、ミステリースネールをつついたり傷つけたりすることがあります。触角や柔らかい部分はとくに狙われやすいので、注意しておくと安心です。',
    'r_invert_assassin_title': 'アサシンスネールと、小さな無脊椎',
    'r_invert_assassin_body': 'アサシンスネールはスネール（害貝）を捕食しますが、小型シュリンプ、とくに稚エビを襲うこともあります。無脊椎を混ぜた水槽では、様子をよく観察してあげてください。',
    'r_zone_benthic_crowd_title': '小さな水槽に底層の魚が複数',
    'r_zone_benthic_crowd_body': '底層で暮らす種（{names}）が複数いると、同じ底床の縄張りを取り合うことになります。{smallTankL} L 未満の水槽では、その摩擦が大きくなりやすいです。',

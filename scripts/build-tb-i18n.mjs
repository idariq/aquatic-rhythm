...
const ENGLISH_RACK_ITEMS = {
  ...
  'chem-media': { name: 'Chemical Media', role: 'Carbon, resin — polish &amp; clarity' },
  ...
  'root-tabs': { name: 'Root Tabs', role: 'Nutrients at the roots' },

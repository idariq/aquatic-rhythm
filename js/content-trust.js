(function () {
  ...
  var CT_STRINGS = {
    en: {
      ...
      photo_ai: 'The wide photo at the top of this guide is AI-generated — not a real photograph of an actual aquarium.',
    ...
    id: {
      ...
      photo_ai: 'Foto lebar di bagian atas panduan ini dihasilkan oleh AI — bukan foto akuarium sungguhan.',
    ...
    ja: {
      ...
      photo_ai: '本ガイド冒頭のワイド写真はAI生成によるものであり、実際の水槽を撮影した写真ではありません。',
  ...
  // AI-generated hero photo disclosure — only on pages that actually have
  // one (.art-hero-figure), so this never claims an AI-generated image on
  // an article that predates the hero-image rollout and has none.
  var aiDisclosureHtml = document.querySelector('.art-hero-figure')
    ? '<p class="art-trust-photo">' + CT('photo_ai') + '</p>'
    : '';

...
.ar-stg-lang-opt{display:flex;align-items:center;justify-content:space-between;width:100%;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;color:rgba(235,240,236,.78);font-family:inherit;font-size:.82rem;font-weight:400;padding:.6rem .85rem;cursor:pointer;text-align:left;text-decoration:none;transition:background .2s,border-color .2s,color .2s;line-height:1.3}
...
.ar-stg-lang-fallback{font-size:.64rem;color:rgba(255,255,255,.32);font-weight:400;letter-spacing:.02em}
